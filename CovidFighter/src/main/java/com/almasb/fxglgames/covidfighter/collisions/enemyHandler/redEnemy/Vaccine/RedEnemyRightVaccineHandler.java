package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.redEnemy.Vaccine;
...
public class RedEnemyRightVaccineHandler extends CollisionHandler {

    public RedEnemyRightVaccineHandler() {
        super(EntityType.RIGHT_VACCINE, EntityType.RED_ENEMY);
    }
