package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.dragon.Arrow;
...
public class DragonRightArrowHandler extends CollisionHandler {

    public DragonRightArrowHandler() {
        super(EntityType.RIGHT_ARROW, EntityType.DRAGON);
    }
