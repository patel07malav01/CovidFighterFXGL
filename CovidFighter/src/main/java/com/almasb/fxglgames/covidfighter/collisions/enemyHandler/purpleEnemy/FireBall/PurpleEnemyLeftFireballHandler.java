...
public class PurpleEnemyLeftFireballHandler extends CollisionHandler {

    public PurpleEnemyLeftFireballHandler() {
        super(EntityType.LEFT_FIREBALL, EntityType.PURPLE_ENEMY);
    }
