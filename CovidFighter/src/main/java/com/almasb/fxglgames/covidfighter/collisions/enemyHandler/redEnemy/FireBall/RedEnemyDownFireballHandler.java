...
public class RedEnemyDownFireballHandler extends CollisionHandler {

    public RedEnemyDownFireballHandler() {
        super(EntityType.DOWN_FIREBALL, EntityType.RED_ENEMY);
    }
