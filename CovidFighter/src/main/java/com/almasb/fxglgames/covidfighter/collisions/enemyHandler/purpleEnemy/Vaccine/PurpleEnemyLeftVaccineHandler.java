...
public class PurpleEnemyLeftVaccineHandler extends CollisionHandler {

    public PurpleEnemyLeftVaccineHandler() {
        super(EntityType.LEFT_VACCINE, EntityType.PURPLE_ENEMY);
    }
