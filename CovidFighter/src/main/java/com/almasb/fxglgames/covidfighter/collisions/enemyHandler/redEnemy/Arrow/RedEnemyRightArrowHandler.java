package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.redEnemy.Arrow;
...
public class RedEnemyRightArrowHandler extends CollisionHandler {

    public RedEnemyRightArrowHandler() {
        super(EntityType.RIGHT_ARROW, EntityType.RED_ENEMY);
    }
