...
public class RedPurpleDownFireballHandler extends CollisionHandler {

    public RedPurpleDownFireballHandler() {
        super(EntityType.DOWN_FIREBALL, EntityType.RED_PURPLE);
    }
