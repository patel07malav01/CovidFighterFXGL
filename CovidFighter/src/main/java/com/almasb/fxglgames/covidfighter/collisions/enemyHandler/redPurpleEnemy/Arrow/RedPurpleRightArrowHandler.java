package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.redPurpleEnemy.Arrow;
...
public class RedPurpleRightArrowHandler extends CollisionHandler {

    public RedPurpleRightArrowHandler() {
        super(EntityType.RIGHT_ARROW, EntityType.RED_PURPLE);
    }
