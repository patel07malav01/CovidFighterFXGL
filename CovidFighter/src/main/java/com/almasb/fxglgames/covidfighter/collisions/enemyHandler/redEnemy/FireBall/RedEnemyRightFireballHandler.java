package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.redEnemy.FireBall;
...
public class RedEnemyRightFireballHandler extends CollisionHandler {

    public RedEnemyRightFireballHandler() {
        super(EntityType.RIGHT_FIREBALL, EntityType.RED_ENEMY);
    }
