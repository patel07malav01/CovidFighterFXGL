...
public class RedPurpleRightVaccineHandler extends CollisionHandler {

    public RedPurpleRightVaccineHandler() {
        super(EntityType.RIGHT_VACCINE, EntityType.RED_PURPLE);
    }
