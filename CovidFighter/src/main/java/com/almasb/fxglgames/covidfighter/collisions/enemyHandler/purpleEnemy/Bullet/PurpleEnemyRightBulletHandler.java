package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.purpleEnemy.Bullet;
...
public class PurpleEnemyRightBulletHandler extends CollisionHandler {

    public PurpleEnemyRightBulletHandler() {
        super(EntityType.RIGHT_BULLET, EntityType.PURPLE_ENEMY);
    }
