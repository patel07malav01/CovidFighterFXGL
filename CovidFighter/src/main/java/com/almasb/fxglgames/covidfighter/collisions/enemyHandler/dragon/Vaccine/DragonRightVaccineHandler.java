package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.dragon.Vaccine;
...
public class DragonRightVaccineHandler extends CollisionHandler {

    public DragonRightVaccineHandler() {
        super(EntityType.RIGHT_VACCINE, EntityType.DRAGON);
    }
