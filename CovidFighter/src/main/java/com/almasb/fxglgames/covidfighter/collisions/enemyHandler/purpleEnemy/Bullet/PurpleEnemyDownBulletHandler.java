...
public class PurpleEnemyDownBulletHandler extends CollisionHandler {

    public PurpleEnemyDownBulletHandler() {
        super(EntityType.DOWN_BULLET, EntityType.PURPLE_ENEMY);
    }
