...
public class RedEnemyLeftFireballHandler extends CollisionHandler {

    public RedEnemyLeftFireballHandler() {
        super(EntityType.LEFT_FIREBALL, EntityType.RED_ENEMY);
    }
