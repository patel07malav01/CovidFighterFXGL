...
public class PurpleEnemyUpVaccineHandler extends CollisionHandler {

    public PurpleEnemyUpVaccineHandler() {
        super(EntityType.UP_VACCINE, EntityType.PURPLE_ENEMY);
    }
