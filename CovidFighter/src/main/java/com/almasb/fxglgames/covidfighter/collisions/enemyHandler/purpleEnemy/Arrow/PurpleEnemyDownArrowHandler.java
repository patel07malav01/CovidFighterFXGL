...
public class PurpleEnemyDownArrowHandler extends CollisionHandler {

    public PurpleEnemyDownArrowHandler() {
        super(EntityType.DOWN_ARROW, EntityType.PURPLE_ENEMY);
    }
