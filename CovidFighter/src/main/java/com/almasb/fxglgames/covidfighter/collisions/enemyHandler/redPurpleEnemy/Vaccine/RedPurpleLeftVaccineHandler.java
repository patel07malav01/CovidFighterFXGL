...
public class RedPurpleLeftVaccineHandler extends CollisionHandler {

    public RedPurpleLeftVaccineHandler() {
        super(EntityType.LEFT_VACCINE, EntityType.RED_PURPLE);
    }
