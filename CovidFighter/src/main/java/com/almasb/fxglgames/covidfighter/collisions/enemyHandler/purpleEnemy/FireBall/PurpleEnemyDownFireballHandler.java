...
public class PurpleEnemyDownFireballHandler extends CollisionHandler {

    public PurpleEnemyDownFireballHandler() {
        super(EntityType.DOWN_FIREBALL, EntityType.PURPLE_ENEMY);
    }
