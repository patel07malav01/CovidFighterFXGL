package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.purpleEnemy.Arrow;
...
public class PurpleEnemyRightArrowHandler extends CollisionHandler {

    public PurpleEnemyRightArrowHandler() {
        super(EntityType.RIGHT_ARROW, EntityType.PURPLE_ENEMY);
    }
