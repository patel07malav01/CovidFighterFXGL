package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.redPurpleEnemy.Bullet;
...
public class RedPurpleRightBulletHandler extends CollisionHandler {

    public RedPurpleRightBulletHandler() {
        super(EntityType.RIGHT_BULLET, EntityType.RED_PURPLE);
    }
