package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.redPurpleEnemy.FireBall;
...
public class RedPurpleRightFireballHandler extends CollisionHandler {

    public RedPurpleRightFireballHandler() {
        super(EntityType.RIGHT_FIREBALL, EntityType.RED_PURPLE);
    }
