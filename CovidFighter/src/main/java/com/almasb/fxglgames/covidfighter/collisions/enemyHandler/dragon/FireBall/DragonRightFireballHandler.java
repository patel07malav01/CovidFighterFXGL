package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.dragon.FireBall;
...
public class DragonRightFireballHandler extends CollisionHandler {

    public DragonRightFireballHandler() {
        super(EntityType.RIGHT_FIREBALL, EntityType.DRAGON);
    }
