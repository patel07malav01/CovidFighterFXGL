...
public class PurpleEnemyLeftBulletHandler extends CollisionHandler {

    public PurpleEnemyLeftBulletHandler() {
        super(EntityType.LEFT_BULLET, EntityType.PURPLE_ENEMY);
    }
