package com.almasb.fxglgames.covidfighter.collisions.enemyHandler.purpleEnemy.FireBall;
 ...
 */
public class PurpleEnemyRightFireballHandler extends CollisionHandler {

    public PurpleEnemyRightFireballHandler() {
        super(EntityType.RIGHT_FIREBALL, EntityType.PURPLE_ENEMY);
    }
