...
public class RedPurpleLeftFireballHandler extends CollisionHandler {

    public RedPurpleLeftFireballHandler() {
        super(EntityType.LEFT_FIREBALL, EntityType.RED_PURPLE);
    }
