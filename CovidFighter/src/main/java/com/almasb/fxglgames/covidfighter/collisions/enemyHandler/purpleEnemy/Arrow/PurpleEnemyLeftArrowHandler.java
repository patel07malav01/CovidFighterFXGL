...
public class PurpleEnemyLeftArrowHandler extends CollisionHandler {

    public PurpleEnemyLeftArrowHandler() {
        super(EntityType.LEFT_ARROW, EntityType.PURPLE_ENEMY);
    }
