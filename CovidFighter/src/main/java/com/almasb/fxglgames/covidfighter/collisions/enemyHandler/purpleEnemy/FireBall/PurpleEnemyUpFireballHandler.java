...
public class PurpleEnemyUpFireballHandler extends CollisionHandler {

    public PurpleEnemyUpFireballHandler() {
        super(EntityType.UP_FIREBALL, EntityType.PURPLE_ENEMY);
    }
